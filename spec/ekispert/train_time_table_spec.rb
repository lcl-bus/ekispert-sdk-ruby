  ...
  describe '.to_train_time_table' do
    ...
    context 'Tokyo station (Yamagata Shinkansen)' do
      ...
      describe '#line_kind_list' do
        it 'return Array, contains TrainTimeTable::LineKind instance' do
          expect(train_time_table.line_kind_list[0].class).to eq Ekispert::TrainTimeTable::LineKind
        end
      end
      describe '#line_destination_list' do
        it 'return Array, contains TrainTimeTable::LineDestination instance' do
          expect(train_time_table.line_destination_list[0].class).to eq Ekispert::TrainTimeTable::LineDestination
        end
      end
      describe '#information_list' do
        it 'return Array, contains TrainTimeTable::Information instance' do
          expect(train_time_table.information_list[0].class).to eq Ekispert::TrainTimeTable::Information
        end
      end
